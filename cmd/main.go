...
func addViewHandlers(init *Initializer, e *echo.Echo) {
	...
	e.GET("/list", entryCtrl.GetListHandler(), proRoute...)
	...
	e.POST("/copy/:id", entryCtrl.PostCopyHandler(), proRoute...)
	e.POST("/delete/:id", entryCtrl.PostDeleteHandler(), proRoute...)
	e.GET("/search", entryCtrl.GetSearchHandler(), proRoute...)
	e.POST("/search", entryCtrl.PostSearchHandler(), proRoute...)
	e.GET("/overview", entryCtrl.GetOverviewHandler(), proRoute...)
