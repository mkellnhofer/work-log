...
// GetExportApiController returns a initialized export API controller object.
func (i *Initializer) GetExportApiController() *ac.ExportController {
	if i.exportACtrl == nil {
