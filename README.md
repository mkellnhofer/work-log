...
The Docker image is available at `ghcr.io/mkellnhofer/work-log:1.5.0`.
...
docker run \
  ...
  --publish 8080:8080 \
  ghcr.io/mkellnhofer/work-log:1.5.0
```
...
1. Extract the archive with `unzip work-log-1.5.0.zip -d work-log`
