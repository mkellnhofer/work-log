...
The Docker image is available at `ghcr.io/mkellnhofer/work-log:1.5.2`.
...
docker run \
  ...
  --publish 8080:8080 \
  ghcr.io/mkellnhofer/work-log:1.5.2
```
...
1. Extract the archive with `unzip work-log-1.5.2.zip -d work-log`
